...
class SparkBuilder:
    ...
    def __init__(self, appname: str):
        path1 = "C:\\Users\\39331\\Desktop\\dataset_estratto\\170826213907_hurricane_harvey_2017_20170903_vol-4.json\\170826213907_hurricane_harvey_2017_20170903_vol-4.json"
        path2 = "C:\\Users\\39331\\Desktop\\dataset_estratto\\170826213907_hurricane_harvey_2017_20170904_vol-5.json\\170826213907_hurricane_harvey_2017_20170904_vol-5.json"
        ...
        path_classificazione = "C:\\Users\\39331\\Desktop\\harvey_data_2017_aidr_classification"
...
class GestoreQuery:
    ...
    #caratteri non ASCII (come emoji e caratteri di altre lingue).ù
        ...
        cleaned = new_dataset.withColumn("clean_text", regexp_replace(col("text"), regex, " "))
    ...
    def top_mentioned_for_categories(self, categories, n=5):
        ...
        ds_esploso = self.dataset.select("AIDRLabel", explode(col("entities.user_mentions"))\
                                .alias("user_mentions"))\
                                .filter(col("AIDRLabel")\
                                .isin(*categories)) #ogni riga possiede la categoria e un utente mezionato
    ...
    def hashtags_distribution_for_category(self, category):
        hashtag = self.dataset.selectExpr("AIDRLabel","created_at", "transform(entities.hashtags,x -> upper(x.text)) as vettore_hashtags")
        hashtag_exploded = hashtag.select("AIDRLabel","created_at",explode(col("vettore_hashtags")))
        ds_data_convertita = hashtag_exploded.withColumn("timestamp", from_unixtime(unix_timestamp(col("created_at"), "EEE MMM dd HH:mm:ss ZZZ yyyy")))
        ds_data_AMG = ds_data_convertita.withColumn("Giorno", date_format(col("timestamp"), "yyyy-MM-dd"))
        if (category != None):
